...
{
    public TMPro.TMP_InputField phonemeInputField;
    ...
    {
        get => phonemeInputField.GetComponent<TMP_InputField>()?.text;
        set { if (phonemeInputField) phonemeInputField.GetComponent<TMP_InputField>().text = value; }
    }
